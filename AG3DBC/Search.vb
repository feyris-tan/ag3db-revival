...
Public Class Search2
    ...
    Public BOOL_FIELD_SIZE As New Size(100, 20)
    Public TYPE_FIELD_SIZE As New Size(100, 20)
    ...
    Private Sub MakeField(ByVal field As Windows.Forms.ColumnHeader, ByVal index As Integer)
        ...
        If field.Tag.tolower = "date" Then
            ...
            AddHandler DirectCast(obj2, Control).KeyPress, AddressOf KeyPressed
        ...
        ElseIf field.Tag.tolower = "type" Then

            obj = New ComboBox
            obj.DropDownStyle = ComboBoxStyle.DropDownList
            obj.items.add(AG3DBType.Character)
            'obj.items.add(AG3DBType.Cloth)
            obj.selectedindex = 0
            obj.Size = TYPE_FIELD_SIZE
            obj.Tag = SearchFieldType.Type
            obj.Location = New Point(MARGIN + l.Size.Width, SPACE_BETWEEN + _nextStartPos)
            _nextStartPos = obj.Location.Y
        ...
        AddHandler DirectCast(obj, Control).KeyPress, AddressOf KeyPressed
    ...
    Private Sub KeyPressed(ByVal sender As System.Object, ByVal e As Windows.Forms.KeyPressEventArgs)
    ...
    Private Function CheckField(ByVal field As SearchField, ByVal value As Object) As Boolean
        ...
        If Not field.Ignore Then
            ...
            Else
                ...
                If NotNothing(field.Value) AndAlso Not value.ToLower.Contains(field.Value.ToString.ToLower) Then
                    Return False
                End If
